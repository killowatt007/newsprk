...
const single_post1 = "/img/blog/single_post1.jpg";
const author2 = "/img/author/author2.png";
const smail1 = "/img/blog/smail1.jpg";
const big1 = "/img/blog/big1.jpg";
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-12">
                            <div className="bridcrumb"><Link href="/">Home</Link> / Archive / post 3</div>
                        </div>
                    </div>
                    <div className="row">
                        <div className="col-md-6 col-lg-8">
                            <div className="shadow6">
                                    ...
                                    <div className="row">
                                        <div className="col-lg-6 align-self-center">
                                            <div className="author">
                                                ...
                                                <ul>
                                                    <li><Link href="/">March 26, 2020</Link>
                                                    </li>
                                ...
                                <div className="video_img">
                                    ...
                                    <Link href="/" className="video_img_icon play_btn"> <FontAwesome name="play"/></Link>
